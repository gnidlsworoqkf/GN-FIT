...
const allQuestions = [
    ...
    // --- 81~100: 상황 판단 문항 (Best/Worst) ---
    {
        ...
        options: [
            "1. 학교의 교육 일정을 존중하여 참여는 무리하게 추진하지 않고, 내년도 학기 초에 우선순위로 방문한다.",
            "2. 숙제 방식 대신, 학교 조회 시간 등을 활용해 5분 영상 시청만으로 참여하는 '초단기 방식'을 제안한다.",
            "3. 이 대회가 아이들에게 '세계 시민 의식'을 심어주는 필수 교육 과정임을 강조하며, 교육 자료의 가치를 설득한다.",
            "4. 인근의 다른 학교들이 대부분 참여하기로 했다는 점을 공유하며, 우리 학교만 빠질 경우의 소외감을 자극한다."
        ]
    },
    {
        id: 82, type: 'BW', category: "문제 해결",
        scenario: "선물금 전달 사진 속 아동의 표정이 너무 굳어 있습니다. 후원자가 \"아동이 선물을 기뻐하지 않는 것 같다\"고 오해할까 봐 걱정되는데, 현지 지부에서는 \"아동이 낯을 많이 가리는 성격이라 최선을 다해 찍은 것\"이라고 합니다.",
        options: [
            "1. 후원자의 만족도가 중요하므로, 현지 지부에 아동이 조금이라도 웃는 모습이 나올 때까지 재촬영을 정중히 요청한다.",
            "2. 사진은 그대로 두되, 아동의 내성적인 성격과 선물에 대해 감사해했던 현지 직원의 코멘트를 보고서에 상세히 담는다.",
            "3. 사진보다는 선물금으로 구매한 물품의 영수증과 시장에서 물건을 고르는 과정 등 '투명한 집행 과정'을 보여준다.",
            "4. 후원자가 실망하지 않도록, 이번 사진은 작게 넣고 아동이 예전에 보냈던 밝은 표정의 사진들을 모아 보완한다."
        ]
    },
    {
        id: 83, type: 'BW', category: "목표 달성",
        scenario: "연말 캠페인 종료가 일주일 남았는데 목표액의 20%가 부족합니다. 팀원들은 거리 홍보로 체력이 바닥났고, \"올해는 경기가 안 좋으니 이 정도면 최선을 다했다\"는 분위기가 지배적입니다.",
        options: [
            "1. 팀원들의 건강과 사기가 우선이므로, 현재 성과를 격려하며 남은 기간은 무리한 활동보다 안정적인 마무리에 집중한다.",
            "2. 지친 팀원들을 독려하여 유동 인구가 가장 많은 시간대에 홍보 화력을 집중하는 단기 총력전을 제안해 끝까지 도전한다.",
            "3. 현재 모금 수치를 데이터로 분석하여, 반응이 가장 좋았던 타겟군이나 후원 채널에 남은 광고 예산을 전면 재배치한다.",
            "4. 목표 미달 시 우리 지부의 내년도 사업비가 줄어들 수 있다는 현실적인 위기감을 공유하며 팀원들을 강하게 압박한다."
        ]
    },
    {
        id: 84, type: 'BW', category: "소속 영향력",
        scenario: "사수 간사가 후원자 개인정보 파기 절차가 너무 번거롭다며 \"일단 이 상자에 모아뒀다가 나중에 한꺼번에 처리하자\"고 합니다. 동료들도 바쁜 일정을 이유로 동조하는 분위기이며, 당신에게도 서류 정리를 도와달라고 합니다.",
        options: [
            "1. 팀의 협력적인 분위기와 사수와의 관계를 고려하여, 이번 건만 선배의 방식대로 돕고 나중에 원칙 준수를 건의한다.",
            "2. \"개인정보 사고는 단체의 신뢰를 무너뜨린다\"는 점을 상기시키며, 정해진 절차대로 즉시 파쇄기에 넣자고 설득한다.",
            "3. 팀 내 갈등을 피하기 위해 내 분량의 서류만 정석대로 파쇄하고, 선배나 동료들이 하는 방식에는 가급적 관여하지 않는다.",
            "4. 팀원 모두가 절차를 지키기 힘든 상황임을 이해하므로, 팀 회의 시 '개인정보 관리 프로세스 자동화' 등 개선안을 제안한다."
        ]
    },
    {
        id: 85, type: 'BW', category: "의사소통",
        scenario: "지역 협력 기관장이 공개적인 자리에서 \"굿네이버스는 행정이 너무 까다로워서 같이 일하기 지친다\"며 불만을 표합니다. 주변 파트너 기관 관계자들이 고개를 끄덕이며 당신의 반응을 살피고 있는 곤란한 상황입니다.",
        options: [
            "1. 단체의 투명성 지표와 행정 원칙을 설명하며, 왜 이 절차가 파트너 기관의 안전을 위해서도 필수적인지 논리적으로 설득한다.",
            "2. 현장에서는 일단 사과하며 기관장의 체면을 세워주고, 회의 후 따로 찾아가 행정 부담을 줄여줄 지원책을 의논한다.",
            "3. 행정적 불편함을 상쇄할 수 있는 굿네이버스만의 독보적인 교육 콘텐츠나 홍보 지원책을 역제안해 실질적 이득을 강조한다.",
            "4. 기관장의 발언이 단체의 대외 이미지에 타격을 줄 수 있으므로, 상급자에게 보고하고 공식적인 유감 표명을 검토한다."
        ]
    },
    {
        id: 86, type: 'BW', category: "조직문화",
        scenario: "지부의 오랜 전통인 '월요 모닝 회의'가 최근 업무량 증가로 시간 낭비라는 의견이 많습니다. 하지만 지부장님은 이 회의가 지부의 정체성과 결속을 다지는 가장 소중한 시간이라고 생각하며 자부심을 느끼십니다.",
        options: [
            "1. 지부장님의 철학을 존중하여 회의에 적극 참여하고, 현장의 감동 사례들을 공유해 회의가 '에너지 충전'의 시간이 되게 한다.",
            "2. 대면 보고 시간은 최소화하고 협업 도구로 사전 공유를 마친 뒤, 회의 때는 '핵심 결정'에만 집중하는 방식을 건의한다.",
            "3. 동료들과 함께 현재 업무량과 회의 소요 시간 데이터를 정리하여, 지부장님께 회의 주기를 변경해달라고 솔직히 건의한다.",
            "4. 회의 형식은 유지하되, 한 달에 한 번은 '현장 방문'이나 '티타임'으로 대체하여 전통을 지키면서도 활력을 주는 안을 제안한다."
        ]
    },
    {
        id: 87, type: 'BW', category: "문제 해결",
        scenario: "해외 아동 성장 보고서 작성 중, 특정 지역 아동들의 수치가 작년과 너무 동일한 것을 발견했습니다. 동료들은 \"현지가 워낙 열악하니 이해하자\"며 넘어가려 하지만, 당신은 이것이 후원자에게 허위 정보를 주는 것이 될까 봐 불안합니다.",
        options: [
            "1. 현지 지부의 물리적 한계를 인정하고, 이번 보고서는 작년 데이터를 바탕으로 보내되 향후 관리 강화를 요청한다.",
            "2. \"데이터는 후원자와의 약속\"임을 강조하며, 시간이 걸리더라도 현지에 정확한 최신 수치를 다시 확인해 달라고 요청한다.",
            "3. 왜 반복된 데이터가 발생하는지 현지 시스템의 문제를 파악하고, 사진이나 편지 등 대체 수단으로 아동의 변화를 증명한다.",
            "4. 후원자가 중복을 눈치채지 못하도록 보고서 양식을 화려하게 바꾸고, 수치보다는 감성적인 스토리텔링 위주로 재구성한다."
        ]
    },
    {
        id: 88, type: 'BW', category: "주도적 능력",
        scenario: "지부의 중요한 고액 후원자 행사 날, 갑작스러운 폭설로 초청 명사가 불참을 통보했습니다. 후원자들은 이미 도착하고 있는데, 프로그램에 큰 구멍이 생겨 행사가 엉망이 될 위기입니다.",
        options: [
            "1. 안전 사고 예방을 위해 행사를 즉시 취소하고, 후원자들에게 사과한 뒤 준비한 기념품을 챙겨드려 안전한 귀가를 돕는다.",
            "2. 명사 강연 대신, 지부 간사들이 직접 겪은 현장의 생생한 감동 사례 발표로 프로그램을 긴급 교체해 진정성을 보여준다.",
            "3. 참석한 후원자들을 소그룹으로 나누어 지부장 및 선임 간사들과 깊이 있는 대화를 나눌 수 있는 '간담회'로 형식을 바꾼다.",
            "4. 명사의 과거 강연 영상을 틀어 시간을 벌고, 대신 후원 아동들의 감사 영상 상영이나 경품 이벤트를 늘려 분위기를 띄운다."
        ]
    },
    {
        id: 89, type: 'BW', category: "의사소통",
        scenario: "중요한 고액 후원자가 규정상 금지된 '아동과의 개별 연락'을 끈질기게 요구합니다. 거절할 경우 후원 중단은 물론 지역사회 내 평판에도 타격이 클 것으로 예상되어 매우 난처한 상황입니다.",
        options: [
            "1. 후원자의 기여도를 고려하여, 이번 한 번만 예외를 인정하고 지부의 참관하에 서신을 직접 주고받게 돕는다.",
            "2. 원칙상 불가능함을 안내하되, 후원자의 열정을 존중해 아동의 영상 메시지나 직접 만든 선물을 추가로 전달해 만족감을 높인다.",
            "3. \"아동 권리 보호\"라는 핵심 가치가 왜 후원자의 후원을 더 가치 있게 만드는지 설명하며, 원칙 준수가 곧 아동 보호임을 설득한다.",
            "4. 직접적인 거절은 관계를 망칠 수 있으므로 답변을 최대한 늦추며 상급자에게 판단을 요청하고, 다른 사업으로 관심을 돌린다."
        ]
    },
    {
        id: 90, type: 'BW', category: "목표 달성",
        scenario: "홍보 문구를 작성했는데, 사수가 \"너무 자극적인 표현이다. 우리 단체는 아동의 존엄성을 우선해야 한다\"며 수정을 요구합니다. 하지만 당신은 그렇게 써야만 모금 클릭률이 높아질 것을 확신합니다.",
        options: [
            "1. 지부의 모금 실적이 시급하므로, 일단 자극적인 표현을 유지하여 성과를 낸 뒤 그 데이터로 나중에 사수를 설득한다.",
            "2. 사수의 조언에 따라 자극적인 표현을 모두 삭제하고, 아동의 밝고 주체적인 변화 가능성에만 초점을 맞춘 카피로 수정한다.",
            "3. 자극적인 묘사 대신 '문제의 심각성'을 데이터로 보여주고, '변화의 희망'을 감성적으로 터치하는 절충안을 만들어 제안한다.",
            "4. 사수의 의견을 따르되, 모금액 감소가 예상되므로 이를 보완하기 위해 오프라인 홍보 등 다른 활동에 더 많은 에너지를 쏟는다."
        ]
    },
    {
        id: 91, type: 'BW', category: "문제 해결",
        scenario: "가정 방문 사례 관리 중, 지원 기준에는 미세하게 미달하지만 실제 생활고가 매우 심각한 위기 가정을 발견했습니다. 동료는 \"원칙을 어기면 형평성 문제가 생긴다\"며 지원이 어렵다고 말합니다.",
        options: [
            "1. 형평성 원칙이 중요하므로 규정대로 지원 불가 결정을 내리고, 대신 지역 내 다른 복지 자원을 연결해 주는 데 집중한다.",
            "2. 해당 가정의 특수성을 상세히 기록하여 지부 사례 회의에 상정하고, 예외적 지원이나 민간 자원 연계가 가능한지 적극 건의한다.",
            "3. 이번 건은 예외로 처리하여 긴급 지원을 실시하고, 사후에 팀장님께 보고하여 상황의 시급성을 인정받으려 노력한다.",
            "4. 지원 기준을 조금 완만하게 해석하여 보고서를 작성함으로써, 실질적인 도움을 줄 수 있는 행정적 근거를 스스로 마련한다."
        ]
    },
    {
        id: 92, type: 'BW', category: "주도적 능력",
        scenario: "캠페인 정산 과정에서 50원의 회계 오차가 발견되었습니다. 담당 사수는 \"금액이 너무 소액이라 원인 찾기에 시간이 더 걸리니 내 개인 돈으로 메우고 넘어가자\"고 제안합니다.",
        options: [
            "1. 팀의 업무 시간을 아끼기 위한 사수의 제안을 수용하고, 대신 다음 정산부터는 오차가 없도록 더 꼼꼼히 검토한다.",
            "2. \"단 1원의 오차도 후원자와의 신뢰 문제\"임을 강조하며, 퇴근이 늦어지더라도 끝까지 영수증을 대조해 원인을 밝혀낸다.",
            "3. 사수의 제안은 거절하되, 일단 해당 금액을 '잡손실' 처리하고 다음 회의 때 정산 프로세스 개선안을 안건으로 올린다.",
            "4. 사수와 갈등을 빚기보다는 일단 제안을 따르고, 나중에 회계 감사 시 문제가 될 수 있음을 조심스럽게 언급하며 주의를 환기한다."
        ]
    },
    {
        id: 93, type: 'BW', category: "소속 영향력",
        scenario: "큰 규모의 지역사회 행사를 앞두고 동료 간사가 업무 과부하로 사소한 실수를 반복합니다. 나에게도 그 영향이 오고 있지만, 동료는 자존심 때문에 도움을 요청하지 않고 혼자 끙끙대고 있습니다.",
        options: [
            "1. 동료가 무능해 보일 수 있으므로 말없이 동료의 일을 가져와 대신 처리해주고 동료에게는 비밀로 한다.",
            "2. 팀장님께 현재 상황을 보고하여 업무 분장을 공식적으로 조정함으로써 팀 전체의 리스크를 방지한다.",
            "3. 동료에게 업무 우선순위를 정해주는 '체크리스트'를 만들어주고, 내가 도울 부분과 동료가 끝낼 부분을 명확히 나눈다.",
            "4. 내 업무 마감이 더 급하므로 동료의 실수로 내 일에 차질이 생기지 않도록 내 업무 경계선만 철저히 관리한다."
        ]
    },
    {
        ...
        options: [
            ...
            "2. 국내외 아동을 구분 짓기보다 모든 아동이 누려야 할 보편적 권리의 가치를 강조하며 시민의 공감을 유도한다.",
            "3. 논쟁이 길어지면 다른 후원자 유치가 어려우므로 가볍게 미소로 넘기고, 후원 의사가 있는 다른 시민에게 집중한다.",
            "4. 국내 사업 보고서 책자를 건네며 \"여기에 모든 답이 있다\"고 말하고, 상세한 내용은 홈페이지를 참고해 달라고 정중히 안내한다."
        ]
    },
    {
        id: 95, type: 'BW', category: "목표 달성",
        scenario: "후원회 밤 행사 당일, 약속했던 후원 기업이 갑작스러운 경영 악화로 후원 취소를 통보했습니다. 대관료와 식비 결제가 급한 상황이며, 이대로라면 지부 목표 실적에 큰 타격이 생깁니다.",
        options: [
            "1. 재정 리스크를 줄이기 위해 행사 규모를 즉시 대폭 축소하고, 이미 주문한 물품들을 취소하여 비용을 아낀다.",
            "2. 지부 내 인적 네트워크를 총동원하여 해당 기업을 대체할 수 있는 긴급 후원처를 발굴하기 위해 남은 시간 총력을 다한다.",
            "3. 해당 기업을 방문해 사정을 청취하고, 액수를 조정하거나 할부 납부 등 파트너십을 유지하며 실적을 방어할 대안을 찾는다.",
            "4. 실적 달성은 어렵더라도 이번 행사는 기존 후원자 감사 관리에만 집중하는 것으로 성격을 바꿔 부담을 덜어낸다."
        ]
    },
    {
        id: 96, type: 'BW', category: "조직문화",
        scenario: "본부 지침으로 도입된 새 전산 시스템이 너무 복잡하여 선배들이 \"현장 다니기도 바쁜데 언제 다 입력하냐\"며 당신에게 입력 업무를 몰아주려 합니다.",
        options: [
            "1. 선배들의 고충에 공감하며, 업무에 방해되지 않도록 퇴근 전후 시간을 내어 선배들의 서류까지 대신 입력해 준다.",
            "2. 새 시스템의 장점(자동화 기능 등)을 먼저 익혀 선배들이 쉽게 쓸 수 있는 '요약 가이드'를 만들어 공유하고 협조를 구한다.",
            "3. 본부 지침임을 강조하며 각자 맡은 분량은 스스로 입력하도록 팀 회의에서 정식으로 건의하고 역할 분담을 명확히 한다.",
            "4. 전산 작업을 내가 전담하겠다고 나서되, 그 대가로 다른 현장 방문이나 행정 업무에서 제외해 달라고 역제안한다."
        ]
    },
    {
        id: 97, type: 'BW', category: "목표 달성",
        scenario: "아동 옹호 캠페인 촬영 중 아이가 너무 쑥스러워하며 거부합니다. 하지만 이 사진이 없으면 오늘 SNS 홍보 일정을 맞출 수 없고 홍보 효과도 기대하기 어렵습니다.",
        options: [
            "1. 아동의 기분을 달래기 위해 간식이나 놀이를 제안하며 아동이 스스로 웃을 때까지 끈기 있게 기다린다.",
            "2. 아동의 거부 의사를 존중하여 촬영을 중단하고, 대신 아동의 소지품이나 그린 그림 등 대체 이미지를 활용해 홍보한다.",
            "3. \"금방 끝난다\"며 아동을 설득하고, 보호자의 도움을 받아 빠르게 촬영을 마친 뒤 편집 작업으로 표정을 보정한다.",
            "4. 홍보의 중요성을 아동에게 설명하고, 이 캠페인이 잘 되어야 다른 친구들도 도움을 받을 수 있다는 점을 강조해 동참을 구한다."
        ]
    },
    {
        id: 98, type: 'BW', category: "문제 해결",
        scenario: "연말 정산 기간에 작년 사업비 중 아주 적은 금액이 남은 것을 발견했습니다. 반납하기엔 서류가 너무 복잡하고, 동료는 \"어차피 소액이니 팀 소모품비로 쓰자\"고 합니다.",
        options: [
            "1. 복잡한 행정 낭비를 줄이기 위해 동료의 제안대로 소액 소모품을 구매해 비치하고 정산 보고서를 마감한다.",
            "2. 아무리 소액이라도 후원금의 목적 외 사용은 불가하므로, 정해진 절차에 따라 반납 처리를 진행하고 투명성을 지킨다.",
            "3. 해당 금액을 아동들을 위한 작은 간식비로 전용하여 실제 수혜자에게 혜택이 돌아가게 하고 보고서를 갈무리한다.",
            "4. 회계 담당자로서 책임을 피하기 위해 해당 사안을 상급자에게 정식 보고하고 어떤 방식으로 처리할지 결정을 기다린다."
        ]
    },
    {
        id: 99, type: 'BW', category: "의사소통",
        scenario: "기획한 SNS 챌린지에 대해 선배 간사가 \"NGO답지 않게 너무 가볍고 장난스러워 보인다. 품위를 지켜야 한다\"며 전면 재검토를 요구합니다.",
        options: [
            "1. 선배의 조언대로 무게감 있는 기획으로 전면 수정하여, 굿네이버스의 전문적이고 진중한 이미지를 지킨다.",
            "2. 젊은 층의 참여를 이끌어내기 위한 트렌드임을 설명하고, 전문성을 해치지 않는 선에서 톤앤매너를 조절한 절충안을 제시한다.",
            "3. 선배의 우려를 반영하되, 일단 소규모로 먼저 실행해 본 뒤 유입 지표와 반응 데이터를 근거로 선배를 설득한다.",
            "4. 내 기획의 참신함을 믿고, 선배의 피드백보다는 팀장님께 직접 기획안을 승인받아 추진력을 확보한다."
        ]
    },
    {
        id: 100, type: 'BW', category: "조직문화",
        scenario: "갑작스러운 인사 이동으로 업무 인수인계가 며칠 만에 마무리되어야 합니다. 전임자가 자료를 다 정리하지 못했는데, 당신은 당장 내일 큰 행사를 주관해야 합니다.",
        options: [
            "1. 전임자를 원망하기보다 밤을 새워서라도 기존 파일을 직접 다 뒤져 행사에 차질이 없도록 완벽히 준비한다.",
            "2. 행사 준비에 꼭 필요한 핵심 정보만 리스트업하여 전임자에게 짧고 굵게 질문하고, 나머지는 내 스타일대로 새롭게 준비한다.",
            "3. 상황의 긴박함을 팀장님께 공유하고, 이번 행사만큼은 팀원들의 협조를 얻어 함께 준비할 수 있도록 지원을 요청한다.",
            "4. 준비 부족으로 행사가 미흡할 수 있음을 미리 공지하고, 행사 후 이번 인수인계 과정의 문제점을 개선안으로 보고한다."
        ]
    }
];
...
function renderTypeAB(q) {
    ...
    <div class="question-item">
        ...
        <div class="options-grid">
            ...
            <div class="option-card ${saved === 'B' ? 'selected' : ''}" onclick="selectOption(${q.id}, 'B')">
