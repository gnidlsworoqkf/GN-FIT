// test.js - Final Strict Version (New Script URL & Korean Keys)
...
// [SUBMIT FUNCTION] - UPDATED FOR USER REQUEST (STRICT KOREAN KEYS)
async function submitTest() {
    ...
    let totalTimeSec = 0;
    if (startTimeStr) {
        totalTimeSec = Math.floor((Date.now() - parseInt(startTimeStr)) / 1000);
    }
