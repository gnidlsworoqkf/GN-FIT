...
const allQuestions = [
    ...
    { id: 9, type: 'AB', category: "주도적 능력", optionA: "업무 중 예상치 못한 문제가 생기면 상황을 정리하고 보고한 뒤 지시를 기다린다.", optionB: "판단할 수 있는 범위 내에서 먼저 움직이고 사후에 보고한다." },
    ...
    { id: 34, type: 'AB', category: "소속 영향력", optionA: "팀이 원하는 방향과 내 판단이 다를 때, 팀 방향에 맞춰 실행한다.", optionB: "내 판단이 더 낫다고 확신하면 끝까지 설득하여 팀 방향을 바꾸려 한다." },
    ...
    { id: 54, type: 'AB', category: "조직문화", optionA: "지금 담당 업무가 내 성장에 도움이 안 된다고 느껴도 맡은 일을 묵묵히 한다.", optionB: "성장에 도움이 안 되는 업무라면 전환이나 변화를 적극적으로 요청한다." },
    { id: 55, type: 'AB', category: "조직문화", optionA: "직급이 명확하여 역할 분담이 확실한 곳이 좋다.", optionB: "직급에 상관없이 수평적으로 소통하는 곳이 좋다." },
    { id: 56, type: 'AB', category: "조직문화", optionA: "마감이 촉박할 때 내부 검토 절차를 일부 줄이고 결과물을 제출한다.", optionB: "마감이 늦어지더라도 정해진 검토 절차를 끝까지 지킨다." },
    { id: 57, type: 'AB', category: "조직문화", optionA: "동료가 나보다 빠르게 성과를 낼 때 자극받아 더 열심히 하게 된다.", optionB: "동료가 어려움에 처했을 때 내 시간을 써서 돕는 것이 자연스럽다." },
    { id: 58, type: 'AB', category: "조직문화", optionA: "팀장이 부재 중일 때도 정해진 프로세스대로 업무를 진행한다.", optionB: "팀장이 없을 때 상황에 맞게 더 유연하게 판단하고 처리한다." },
    ...
    { id: 64, type: 'AB', category: "문제 해결", optionA: "갈등 원인을 파악하여 재발을 막는 게 급선무다.", optionB: "당사자들이 합의할 수 있는 지점을 찾는 게 급선무다." },
    { id: 65, type: 'AB', category: "목표 달성", optionA: "결과가 조금 미흡해도 과정이 좋았다면 만족한다.", optionB: "어떤 과정이었든 간에 최종 결과로 가치를 증명한다." },
    { id: 66, type: 'AB', category: "목표 달성", optionA: "한 번 정한 목표치는 어떤 경우에도 달성해야 한다.", optionB: "상황에 따라 목표치는 현실적으로 조정될 수 있다." },
    { id: 67, type: 'AB', category: "소속 영향력", optionA: "내게 맡겨진 임무를 완벽히 끝내는 데 몰입한다.", optionB: "동료의 업무가 막혀 있다면 내 일을 미루고라도 돕는다." },
    { id: 68, type: 'AB', category: "소속 영향력", optionA: "팀원들이 언제든 편하게 다가올 수 있는 동료가 되고 싶다.", optionB: "팀원들에게 업무적으로 신뢰받는 전문가가 되고 싶다." },
    ...
    { id: 72, type: 'AB', category: "조직문화", optionA: "직급에 상관없이 누구나 자유롭게 의견을 내는 곳이 편하다.", optionB: "직급에 따른 위계와 질서가 명확한 곳이 편하다." },
    { id: 73, type: 'AB', category: "조직문화", optionA: "기존의 업무 방식과 조직의 문법을 먼저 익힌다.", optionB: "기존 방식에 얽매이지 않고 새로운 관점을 제시한다." },
    { id: 74, type: 'AB', category: "주도적 능력", optionA: "스스로 과업을 정의하고 업무 범위를 확장한다.", optionB: "주어진 과업의 범위 내에서 최선을 다한다." },
    { id: 75, type: 'AB', category: "문제 해결", optionA: "실행 속도보다 발생 가능한 리스크를 줄이는 게 더 중요하다.", optionB: "리스크를 감수하더라도 빠른 실행으로 답을 찾는 게 더 중요하다." },
    { id: 76, type: 'AB', category: "목표 달성", optionA: "남들이 포기할 때도 끝까지 몰입하여 압도적인 결과를 낸다.", optionB: "주변과 보조를 맞추며 무난한 성과를 유지한다." },
    { id: 77, type: 'AB', category: "소속 영향력", optionA: "팀의 목표 달성과 객관적인 업무 피드백을 우선한다.", optionB: "팀의 원만한 인간관계를 유지하는 것을 우선한다." },
    { id: 78, type: 'AB', category: "의사소통", optionA: "상대방이 거부감을 느끼지 않도록 부드럽게 설득한다.", optionB: "정확한 사실과 논리를 바탕으로 단도직입적으로 설득한다." },
    { id: 79, type: 'AB', category: "조직문화", optionA: "변화에 기민하고 자율성이 보장되는 조직이 편하다.", optionB: "사전에 약속된 체계와 일관성이 있는 조직이 편하다." },
    ...
    { id: 86, type: 'BW', category: "조직문화", scenario: "사업장의 오랜 전통인 '월요 모닝 회의'가 최근 업무량 증가로 시간 낭비라는 의견이 많습니다. 하지만 본부장님은 이 회의가 사업장의 정체성과 결속을 다지는 가장 소중한 시간이라고 생각하며 자부심을 느끼십니다.", options: ["1. 본부장님의 철학을 존중하여 회의에 적극 참여하고, 현장의 감동 사례들을 공유해 회의가 '에너지 충전'의 시간이 되게 한다.", "2. 대면 보고 시간은 최소화하고 협업 도구로 사전 공유를 마친 뒤, 회의 때는 '핵심 결정'에만 집중하는 방식을 건의한다.", "3. 동료들과 함께 현재 업무량과 회의 소요 시간 데이터를 정리하여, 본부장님께 회의 주기를 변경해달라고 솔직히 건의한다.", "4. 회의 형식은 유지하되, 한 달에 한 번은 '현장 방문'이나 '티타임'으로 대체하여 전통을 지키면서도 활력을 주는 안을 제안한다."] },
    { id: 87, type: 'BW', category: "문제 해결", scenario: "해외 아동 성장 보고서 작성 중, 특정 지역 아동들의 수치가 작년과 너무 동일한 것을 발견했습니다. 동료들은 \"현지가 워낙 열악하니 이해하자\"며 넘어가려 하지만, 당신은 이것이 후원자에게 허위 정보를 주는 것이 될까 봐 불안합니다.", options: ["1. 현지 사업장의 물리적 한계를 인정하고, 이번 보고서는 작년 데이터를 바탕으로 보내되 향후 관리 강화를 요청한다.", "2. \"데이터는 후원자와의 약속\"임을 강조하며, 시간이 걸리더라도 현지에 정확한 최신 수치를 다시 확인해 달라고 요청한다.", "3. 왜 반복된 데이터가 발생하는지 현지 시스템의 문제를 파악하고, 사진이나 편지 등 대체 수단으로 아동의 변화를 증명한다.", "4. 후원자가 중복을 눈치채지 못하도록 보고서 양식을 화려하게 바꾸고, 수치보다는 감성적인 스토리텔링 위주로 재구성한다."] },
    { id: 88, type: 'BW', category: "주도적 능력", scenario: "사업장의 중요한 고액 후원자 행사 날, 갑작스러운 폭설로 초청 명사가 불참을 통보했습니다. 후원자들은 이미 도착하고 있는데, 프로그램에 큰 구멍이 생겨 행사가 엉망이 될 위기입니다.", options: ["1. 안전 사고 예방을 위해 행사를 즉시 취소하고, 후원자들에게 사과한 뒤 준비한 기념품을 챙겨드려 안전한 귀가를 돕는다.", "2. 명사 강연 대신, 사업장 직원들이 직접 겪은 현장의 생생한 감동 사례 발표로 프로그램을 긴급 교체해 진정성을 보여준다.", "3. 참석한 후원자들을 소그룹으로 나누어 본부장 및 선임 직원들과 깊이 있는 대화를 나눌 수 있는 '간담회'로 형식을 바꾼다.", "4. 명사의 과거 강연 영상을 틀어 시간을 벌고, 대신 후원 아동들의 감사 영상 상영이나 경품 이벤트를 늘려 분위기를 띄운다."] },
    { id: 89, type: 'BW', category: "의사소통", scenario: "중요한 고액 후원자가 규정상 금지된 '아동과의 개별 연락'을 끈질기게 요구합니다. 거절할 경우 후원 중단은 물론 지역사회 내 평판에도 타격이 클 것으로 예상되어 매우 난처한 상황입니다.", options: ["1. 후원자의 기여도를 고려하여, 이번 한 번만 예외를 인정하고 사업장의 참관하에 서신을 직접 주고받게 돕는다.", "2. 원칙상 불가능함을 안내하되, 후원자의 열정을 존중해 아동의 영상 메시지나 직접 만든 선물을 추가로 전달해 만족감을 높인다.", "3. \"아동 권리 보호\"라는 핵심 가치가 왜 후원자의 후원을 더 가치 있게 만드는지 설명하며, 원칙 준수가 곧 아동 보호임을 설득한다.", "4. 직접적인 거절은 관계를 망칠 수 있으므로 답변을 최대한 늦추며 상급자에게 판단을 요청하고, 다른 사업으로 관심을 돌린다."] },
    { id: 90, type: 'BW', category: "목표 달성", scenario: "홍보 문구를 작성했는데, 사수가 \"너무 자극적인 표현이다. 우리 단체는 아동의 존엄성을 우선해야 한다\"며 수정을 요구합니다. 하지만 당신은 그렇게 써야만 모금 클릭률이 높아질 것을 확신합니다.", options: ["1. 사업장의 모금 실적이 시급하므로, 일단 자극적인 표현을 유지하여 성과를 낸 뒤 그 데이터로 나중에 사수를 설득한다.", "2. 사수의 조언에 따라 자극적인 표현을 모두 삭제하고, 아동의 밝고 주체적인 변화 가능성에만 초점을 맞춘 카피로 수정한다.", "3. 자극적인 묘사 대신 '문제의 심각성'을 데이터로 보여주고, '변화의 희망'을 감성적으로 터치하는 절충안을 만들어 제안한다.", "4. 사수의 의견을 따르되, 모금액 감소가 예상되므로 이를 보완하기 위해 오프라인 홍보 등 다른 활동에 더 많은 에너지를 쏟는다."] },
    { id: 91, type: 'BW', category: "문제 해결", scenario: "가정 방문 사례 관리 중, 지원 기준에는 미세하게 미달하지만 실제 생활고가 매우 심각한 위기 가정을 발견했습니다. 동료는 \"원칙을 어기면 형평성 문제가 생긴다\"며 지원이 어렵다고 말합니다.", options: ["1. 형평성 원칙이 중요하므로 규정대로 지원 불가 결정을 내리고, 대신 지역 내 다른 복지 자원을 연결해 주는 데 집중한다.", "2. 해당 가정의 특수성을 상세히 기록하여 사업장 사례 회의에 상정하고, 예외적 지원이나 민간 자원 연계가 가능한지 적극 건의한다.", "3. 이번 건은 예외로 처리하여 긴급 지원을 실시하고, 사후에 팀장님께 보고하여 상황의 시급성을 인정받으려 노력한다.", "4. 지원 기준을 조금 완만하게 해석하여 보고서를 작성함으로써, 실질적인 도움을 줄 수 있는 행정적 근거를 스스로 마련한다."] },
    ...
    { id: 95, type: 'BW', category: "목표 달성", scenario: "후원회 밤 행사 당일, 약속했던 후원 기업이 갑작스러운 경영 악화로 후원 취소를 통보했습니다. 대관료와 식비 결제가 급한 상황이며, 이대로라면 사업장 목표 실적에 큰 타격이 생깁니다.", options: ["1. 재정 리스크를 줄이기 위해 행사 규모를 즉시 대폭 축소하고, 이미 주문한 물품들을 취소하여 비용을 아낀다.", "2. 사업장 내 인적 네트워크를 총동원하여 해당 기업을 대체할 수 있는 긴급 후원처를 발굴하기 위해 남은 시간 총력을 다한다.", "3. 해당 기업을 방문해 사정을 청취하고, 액수를 조정하거나 할부 납부 등 파트너십을 유지하며 실적을 방어할 대안을 찾는다.", "4. 실적 달성은 어렵더라도 이번 행사는 기존 후원자 감사 관리에만 집중하는 것으로 성격을 바꿔 부담을 덜어낸다."] },
